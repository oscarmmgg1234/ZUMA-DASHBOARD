        ...
        <div className="absolute z-20 mt-1 w-64 rounded-xl border border-gray-200 bg-white shadow-lg">
          <div className="p-2">
            <input
              ...
              placeholder="Filter..."
              className="w-full rounded-lg border border-gray-300 bg-white px-2 py-1 text-sm text-black placeholder:text-gray-500 outline-none focus:ring-2 focus:ring-gray-900/20"
            />
          </div>
          ...
          <div className="mb-3 flex items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select
                ...
                className="w-24 rounded-xl border border-gray-300 bg-white px-2 py-2 text-sm text-black outline-none focus:ring-2 focus:ring-gray-900/20"
              >
          ...
          <div className="h-[72vh] overflow-auto rounded-2xl border border-gray-200">
            <div className="sticky top-0 z-[1] -mx-4 border-b border-gray-100 bg-white px-4 py-3">
              <input
                ...
                className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-black placeholder:text-gray-500 outline-none focus:ring-2 focus:ring-gray-900/20"
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-white px-2 py-2 text-sm text-black outline-none focus:ring-2 focus:ring-gray-900/20"
                  >
                    <option value="ASC">A–Z</option>
                    <option value="DESC">Z–A</option>
                  </select>
